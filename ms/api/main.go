...
func main() {
	...
	r.HandleFunc("/users", handlers.RegisterUserHandler).Methods(http.MethodPost)            // Corrected: /users
	r.HandleFunc("/users/{username}", handlers.RemoveUserHandler).Methods(http.MethodDelete) // Corrected: /users
